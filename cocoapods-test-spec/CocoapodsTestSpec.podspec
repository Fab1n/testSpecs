...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "A short description of CocoapodsTestSpec."
  ...
  # Or just: spec.author    = "Fabian Renner"
  # spec.authors            = { "Fabian Renner" => "rennerfabian@icloud.com" }
  # spec.social_media_url   = "https://twitter.com/Fabian Renner"
